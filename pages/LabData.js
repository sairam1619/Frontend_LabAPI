export const labData = {
  iam: {
    ...
    description:
      "Learn AWS Identity and Access Management through guided deep dive laboratories. Select a lab below to explore objectives, AWS services, lab sections, and common troubleshooting guidance.",

    searchPlaceholder: "Search IAM labs...",
